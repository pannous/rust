...
impl<'v> ast_visit::Visitor<'v> for StatCollector<'v> {
    ...
    fn visit_expr(&mut self, e: &'v ast::Expr) {
        ...
        record_variants!(
            ...
            [
                Array, ConstBlock, Call, MethodCall, OptionalMethodCall, Tup, Binary, NullCoalesce,
                Unary, Lit, Cast, Type, Let, If, While, ForLoop, Loop, Match, Closure, Block, Await,
                Use, TryBlock, Assign, AssignOp, Field, OptionalField, Index, Range, Underscore,
