...
impl<'v> ast_visit::Visitor<'v> for StatCollector<'v> {
    ...
    fn visit_expr(&mut self, e: &'v ast::Expr) {
        ...
        record_variants!(
            ...
            [
                Array, ConstBlock, Call, MethodCall, OptionalMethodCall, Tup, Binary, Unary, Lit,
                Cast, Type, Let, If, While, ForLoop, Loop, Match, Closure, Block, Await, Use,
                TryBlock, Assign, AssignOp, Field, OptionalField, Index, Range, Underscore, Path,
                AddrOf, Break, Continue, Ret, InlineAsm, FormatArgs, OffsetOf, MacCall, Struct,
                Repeat, Paren, Try, Yield, Yeet, Become, IncludedBytes, Gen, UnsafeBinderCast,
                Err, Dummy
            ]
        );
